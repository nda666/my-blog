  ...
  return (
    <div className="px-10 mb-10">
      <nav className="flex w-full " aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-3 text-ellipsis whitespace-nowrap overflow-hidden">
          {breadCrumbs.map(
            (breadCrumb, index) =>
              !breadCrumb.active && (
                <li key={index}>
                  <div className="flex items-center">
                    ...
                    <Link
                      to={breadCrumb.path}
                      className={`capitalize link link-hover link-primary`}
                    >
